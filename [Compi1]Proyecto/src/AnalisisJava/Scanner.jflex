...
<COMENTARIO1> [\n] {}
<COMENTARIO1> [^"*/"] {SintacticoJava alv = new SintacticoJava();nomb += ""+yytext();}
<COMENTARIO1> "*/" {SintacticoJava alv = new SintacticoJava();
                        if(alv.comentarios==" "){
                            alv.comentarios += "{"+'"'+"texto"+'"'+":"+'"'+nomb+'"'+"}";
                            alv.json5 = '"'+"Comentarios"+'"'+":[" + alv.comentarios + "]";
                            alv.json = "{" + alv.json1 + alv.json2 + alv.json3 + alv.json4 + alv.json5 + "}";
                            alv.COMENTARIOS += nomb + "|";
                        }else{
                            alv.comentarios += ",{"+'"'+"texto"+'"'+":"+'"'+nomb+'"'+"}";
                            alv.json5 = '"'+"Comentarios"+'"'+":[" + alv.comentarios + "]";
                            alv.json = "{" + alv.json1 + alv.json2 + alv.json3 + alv.json4 + alv.json5 + "}";
                            alv.COMENTARIOS += nomb + "|";
                        }nomb="";yybegin(YYINITIAL);}

<YYINITIAL> "//" {yybegin(COMENTARIO2);sin.al.add("comentario de una linea ");System.out.println("comentario unilinea ");}
<COMENTARIO2> [^\n] {SintacticoJava alv = new SintacticoJava();nomb += ""+yytext();}
<COMENTARIO2> [\n] {SintacticoJava alv = new SintacticoJava();
                        if(alv.comentarios==" "){
                            alv.comentarios += "{"+'"'+"texto"+'"'+":"+'"'+nomb+'"'+"}";
                            alv.json5 = '"'+"Comentarios"+'"'+":[" + alv.comentarios + "]";
                            alv.json = "{" + alv.json1 + alv.json2 + alv.json3 + alv.json4 + alv.json5 + "}";
