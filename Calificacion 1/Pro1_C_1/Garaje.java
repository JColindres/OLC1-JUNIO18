public class Garaje {
    ...
    public void agregarVehiculo( Carro cars){
    	...
    	men=("Vehiculo agregado correctamente.");
    }
    ...
    */
    ...
    private void LimpiarGarage(){
    	men=("Preparando el sistema de LIMPIEZA.");
    	...
    	do{
    		...
    		while(segundos_trabajo>0){
    			men=("Ralizando limpieza interna, Segundo actual -> "+segundos_trabajo);
    			segundos_trabajo = segundos_trabajo -1;
    		}
    		men=("Realizando limpieza externa, Minuto actual -> "+minutos_trabajo);
    ...
    private void ordenarVehiculos(){
    	...
    	do{
    		do{
    			Carro car_tmp= pos1;
    			men=("El automovil se encuntra en la posicion -> " + i + "," + j);
    			j = j-1;
    		}while(j>0);
    		i=i-1;
    	}while( i>0);
    	men=("Se llevo a cabo el ordenamiento de vehiculos.");
    }
