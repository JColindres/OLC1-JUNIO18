...
namespace _Compi1_Proyecto2.Analizador
{
    public class Gramatica : Grammar
    {
        ...
        {
            #region ER
            NumberLiteral doble = new NumberLiteral("numero");
            IdentifierTerminal id = new IdentifierTerminal("id");
            StringLiteral cadena = TerminalFactory.CreateCSharpString("cadena");
            StringLiteral carac = TerminalFactory.CreateCSharpChar("caracter");
            ...
            DIBUJAR.Rule = DibujarAST + parA + id + parC + pYc
                        | DibujarEXP + parA + EXPL + parC + pYc
                        | DibujarTS + parA + parC + pYc;

            MOSTRAR.Rule = Mostrar + parA + cadena + coma + MOST + parC + pYc
                         | Mostrar + parA + cadena + parC + pYc;
