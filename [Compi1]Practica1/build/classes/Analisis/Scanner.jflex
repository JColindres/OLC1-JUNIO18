...
<YYINITIAL> "continue"          {return new Symbol(sym.resContinue,yycolumn,yyline,yytext());}
...
<YYINITIAL> "!="             {return new Symbol(sym.diferente,yycolumn,yyline,yytext());} 
...
/* COMENTARIOS */
<YYINITIAL> "/*"    {yybegin(COMENTARIO1);sin.al.add("/*");}
<COMENTARIO1> [\n] {sin.al.add("\n");}
<COMENTARIO1> [^"*/"] {sin.al.add(yytext());}
<COMENTARIO1> "*/" {sin.al.add("*/");yybegin(YYINITIAL);}

<YYINITIAL> "//" {yybegin(COMENTARIO2);sin.al.add("//");}
<COMENTARIO2> [^\n] {sin.al.add(yytext());}
<COMENTARIO2> [\n] {yybegin(YYINITIAL);}
